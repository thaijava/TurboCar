...
public class TurboCarLite extends JComponent implements Runnable, KeyListener, ComponentListener {
    ...
    public TurboCarLite( ) throws IOException, ClassNotFoundException{
    ...
    public void paintComponent(Graphics g) {
        ...
        int carSizeX = (int) (TurboCarComponent.TILE_SIZE / rescaleX);
        int carSizeY = (int) (TurboCarComponent.TILE_SIZE / rescaleY);
    ...
    public static void main(String[] args) {
        ...
        TurboCarLite turboCarComponent;
        try {
            turboCarComponent = new TurboCarLite();
        } catch (IOException e) {
            throw new RuntimeException(e);
